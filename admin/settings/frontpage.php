...
if (!during_initial_install()) { //do not use during installation
    ...
    if ($hassiteconfig or has_any_capability(array(
        ...
        $temp->add(new admin_setting_courselist_frontpage_by_role('manager'));
        $temp->add(new admin_setting_courselist_frontpage_by_role('editingteacher'));
        $temp->add(new admin_setting_courselist_frontpage_by_role('student'));
